...
const toggleFavorite = () => {
  ...
  if (isFavorited) {
    ...
    fetch(`http://18.140.119.246:3000/api/user/RemoveFavorites/${maidId}`, {
      method: 'DELETE',
      credentials: 'include',
    })
      .then((res) => {
    ...
    fetch('http://18.140.119.246:3000/api/user/favorites', {
      method: 'POST',
  ...
  return (
    <Card  
        ...
        component="img"
        height="200"
        image={`http://18.140.119.246:3000${maid.imageUrl}`  || maidPic}
        alt={maid.name}
        sx={{
            width: {
